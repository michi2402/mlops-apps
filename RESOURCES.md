...
| cert-manager controller / webhook / cainjector | <61Mi / <61Mi / 107Mi | 64 / 64 / 128Mi | 128 / 128 / 256Mi | `apps/cert-manager.yaml` |
...
`RUNBOOK.md`): MLflow runs one server worker at 512Mi (not yet observed), and the Kafka
broker requests 512Mi (observed 404Mi).
